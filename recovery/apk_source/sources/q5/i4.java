...
public final class i4 extends kotlin.jvm.internal.l implements m7.n {
    ...
    public final /* synthetic */ s7 f8929d;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public /* synthetic */ i4(s7 s7Var, int i8) {
        super(2);
        this.f8928c = i8;
        this.f8929d = s7Var;
    }
    ...
    public final Object invoke(Object obj, Object obj2) {
        switch (this.f8928c) {
            case LottieConstants.$stable /* 0 */:
                ...
                j1.g N = b5.t.N();
                i0.f2.b(N, "Active " + this.f8929d, androidx.compose.foundation.layout.c.h(w0.m.Companion, 16), 0L, mVar, 384, 8);
                return z6.j0.f14164a;
            default:
                k0.m mVar2 = (k0.m) obj;
                if ((((Number) obj2).intValue() & 11) == 2) {
