...
public final class JsonArray extends JsonElement implements List<JsonElement>, n7.a {
    ...
    public /* bridge */ /* synthetic */ void add(int i8, JsonElement jsonElement) {
    ...
    public boolean equals(Object obj) {
        return k.a(this.content, obj);
    }

    @Override // java.util.List
    public JsonElement get(int i8) {
        return this.content.get(i8);
    }
    ...
    @Override // java.util.List
    public /* bridge */ /* synthetic */ JsonElement remove(int i8) {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }
    ...
    @Override // java.util.List
    public /* bridge */ /* synthetic */ JsonElement set(int i8, JsonElement jsonElement) {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }
    ...
    @Override // java.util.List
    public List<JsonElement> subList(int i8, int i10) {
        return this.content.subList(i8, i10);
    }
    ...
    public String toString() {
        return t.K0(this.content, ",", "[", "]", null, 56);
    }

    /* renamed from: add  reason: avoid collision after fix types in other method */
    public void add2(int i8, JsonElement jsonElement) {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }
    ...
    public ListIterator<JsonElement> listIterator(int i8) {
        return this.content.listIterator(i8);
    }

    @Override // java.util.List
    /* renamed from: remove  reason: avoid collision after fix types in other method */
    public JsonElement remove2(int i8) {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }

    /* renamed from: set  reason: avoid collision after fix types in other method */
    public JsonElement set2(int i8, JsonElement jsonElement) {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }
