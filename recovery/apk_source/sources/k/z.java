...
public class z extends ImageView {
    ...
    public boolean hasOverlappingRendering() {
        if (!(this.mImageHelper.f5783a.getBackground() instanceof RippleDrawable) && super.hasOverlappingRendering()) {
            return true;
        }
        return false;
    }
    ...
    public void setImageDrawable(Drawable drawable) {
        ...
        if (yVar2 != null) {
            ...
            if (!this.mHasLevel) {
                ...
                ImageView imageView = yVar3.f5783a;
                if (imageView.getDrawable() != null) {
                    imageView.getDrawable().setLevel(yVar3.f5785c);
                }
            }
        }
    }
