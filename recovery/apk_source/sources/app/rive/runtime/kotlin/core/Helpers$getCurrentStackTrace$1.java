...
public final class Helpers$getCurrentStackTrace$1 extends l implements k {
    public static final Helpers$getCurrentStackTrace$1 INSTANCE = new Helpers$getCurrentStackTrace$1();

    public Helpers$getCurrentStackTrace$1() {
        super(1);
    }
