...
public class Keyframe<T> {
    ...
    public Keyframe(LottieComposition lottieComposition, T t, T t6, Interpolator interpolator, float f10, Float f11) {
    ...
    public boolean containsProgress(float f10) {
        if (f10 >= getStartProgress() && f10 < getEndProgress()) {
            return true;
        }
        return false;
    }

    public Keyframe<T> copyWith(T t, T t6) {
        return new Keyframe<>(t, t6);
    }
    ...
    public float getEndProgress() {
        ...
        if (this.endProgress == Float.MIN_VALUE) {
            if (this.endFrame == null) {
                ...
                this.endProgress = (float) (startProgress + ((this.endFrame.floatValue() - this.startFrame) / this.composition.getDurationFrames()));
            }
        }
    ...
    public Keyframe(LottieComposition lottieComposition, T t, T t6, Interpolator interpolator, Interpolator interpolator2, float f10, Float f11) {
        this.startValueFloat = UNSET_FLOAT;
        this.endValueFloat = UNSET_FLOAT;
        this.startValueInt = UNSET_INT;
        this.endValueInt = UNSET_INT;
    ...
    public Keyframe(LottieComposition lottieComposition, T t, T t6, Interpolator interpolator, Interpolator interpolator2, Interpolator interpolator3, float f10, Float f11) {
        this.startValueFloat = UNSET_FLOAT;
        this.endValueFloat = UNSET_FLOAT;
        this.startValueInt = UNSET_INT;
        this.endValueInt = UNSET_INT;
